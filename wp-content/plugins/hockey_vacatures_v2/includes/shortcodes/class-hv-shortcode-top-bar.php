        ...
        <div id="vacatures-top-bar" class="top-bar container-fluid">
            <div class="container">
                <div class="row">
                    ...
                    <?php if(is_post_type_archive('vacature')): ?>
                        ...
                        <?php endif; ?>
                    <?php elseif(is_singular('vacature')): ?>
                        ...
                        <?php if(get_current_user_id() == $post->post_author): ?>
                            <?php if( current_user_can( 'edit_vacatures' ) ) : ?>
                                <div class="top-bar-item col-3">
                                    <a href="<?php echo home_url() ?>/bewerk-vacature?id=<?php echo $post->ID; ?>" class="icon-left"><i class="fa fa-pencil"></i><?php echo __( 'Bewerken', TEXTDOMAIN ); ?></a>
                                </div>
                            <?php endif; ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="top-bar-item col-3">
                                <a id="new-vacature" href="<?php echo get_post_type_archive_link( 'vacature' );; ?>" class="icon-left"><i class="fa fa-pencil-square-o"></i><?php echo __( 'Alle Vacatures', TEXTDOMAIN ); ?></a>
                            </div>
                        <?php endif; ?>
